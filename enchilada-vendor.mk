...
PRODUCT_COPY_FILES += \
    ...
    vendor/oneplus/enchilada/proprietary/vendor/bin/hw/android.hardware.biometrics.fingerprint@2.1-service.oneplus:$(TARGET_COPY_OUT_VENDOR)/bin/hw/android.hardware.biometrics.fingerprint@2.1-service.oneplus \
